		...
		<div class="header-top">
			<div class="container">
				...
				<div class="pull-right auto-width-right">
					...
					@if(Auth::check())	
						<li><a href="{{route('login')}}">Chào {{Auth::user()->full_name}}</a></li>
			...
			<div class="container beta-relative">
				...
				<div class="pull-right beta-components space-left ov">
					...
					<div class="beta-comp">
						@if(Session('cart'))
						<div class="cart">
							<div class="beta-select"><i class="fa fa-shopping-cart"></i> Giỏ hàng (@if(Session::has('cart')){{Session('cart')->totalQty}} @else Empty @endif) <i class="fa fa-chevron-down"></i></div>
							<div class="beta-dropdown cart-body">
								...
								<div class="cart-caption">
									<div class="cart-total text-right">Tổng tiền: <span class="cart-total-value"><span>{{number_format(Session('cart')->totalPrice)}} đồng</span></div>
									<div class="clearfix"></div>
